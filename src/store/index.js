  ...
  actions: {
    ...
    login: async (context, payload) => {
      ...
      const response = await fetch(
        ...
        `https://bookdomtest101.herokuapp.com/users?email=${email}&password=${password}`
      );
    ...
    getBooks: async (context) => {
      ...
      fetch("https://bookdomtest101.herokuapp.com/books")
        .then((res) => res.json())
    ...
    // SHOW ONE BOOK
    getBook: async (id) => {
      fetch("http://localhost:6969/books/" + id)
      // fetch("https://bookdomtest101.herokuapp.com/books/" + id)
        .then((response) => response.json())
    ...
    deleteUser: async (context, id) => {
      ...
      fetch("https://bookdomtest101.herokuapp.com/users/" + id, {
        method: "DELETE",
      })
        .then((response) => response.json())
        .then((json) => context.commit("setUser", json));
